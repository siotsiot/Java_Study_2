...
class SBasic {
    ...
    private void scanLabels() throws InterpreterException {
        ...
        getToken();
        if (tokType == NUMBER)
            // labelTable.put(token, new Integer(progIdx)); 이 코드는 Java 9 이상에서 deprecated
        ...
        do {
            ...
            if (tokType == NUMBER) { // 줄 번호
                // result = labelTable.put(token, new Integer(progIdx)); 이 코드는 Java 9 이상에서 deprecated
    ...
    private void print() throws InterpreterException {
        ...
        do {
            ...
            if (tokType == QUOTEDSTR) { // 문자열
                ...
                // 현재의 합계에 결과 길이를 더함
                // Double t = new Double(result); 이 코드는 Java 9 이상에서 deprecated
    ...
    private void gosub() throws InterpreterException {
        ...
        if (loc == null)
            ...
            // 리털될 위치를 저장
            // gStack.push(new Integer(progIdx)); 이 코드는 Java 9 이상에서 deprecated
